...
PARAM$finalmodel$num_iterations <- 235
PARAM$finalmodel$learning_rate <- 0.0316614713691274
PARAM$finalmodel$feature_fraction <- 0.981985827230884
PARAM$finalmodel$min_data_in_leaf <- 377
PARAM$finalmodel$num_leaves <- 645
