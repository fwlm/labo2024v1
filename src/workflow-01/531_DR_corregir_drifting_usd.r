...
#------------------------------------------------------------------------------
# deflaciona por TC USD
# momento 1.0  31-dic-2020 a las 23:59

drift_deflacion_usd <- function(campos_monetarios) {
  vfoto_mes <- c(
    201901, 201902, 201903, 201904, 201905, 201906,
    201907, 201908, 201909, 201910, 201911, 201912,
    202001, 202002, 202003, 202004, 202005, 202006,
  ...
  vUSD <- c(
    0.4280112045, 0.4492997199, 0.4963585434, 0.506442577, 0.5131652661, 0.487394958, 0.5030812325, 0.6834733894, 0.6610644258, 0.7114845938, 0.6974789916, 0.7058823529, 0.7058823529, 0.7170868347, 0.7366946779, 0.7703081232, 0.7899159664, 0.8235294118, 0.8543417367, 0.8739495798, 0.8963585434, 0.9355742297, 0.9691876751, 1, 1.0336134454, 1.0588235294, 1.0924369748, 1.1036414566, 1.1176470588, 1.1288515406, 1.1400560224, 1.1512605042, 1.1652661064
  )
...
switch(PARAM$metodo,
       ...
       "deflacion_usd"  = drift_deflacion_usd(campos_monetarios)
)
